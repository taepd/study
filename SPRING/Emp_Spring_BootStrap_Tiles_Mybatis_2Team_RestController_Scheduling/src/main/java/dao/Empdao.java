...
public interface Empdao {
	...
	public int updateCstate(String[] array);
	...
	// 사원 수 조회
	public int getEmpCount(String column, int search);
	public int getEmpCount();

	// 사원번호로 검색하기
	public List<Emp> getEmpListByEmpno(int cpage, int pagesize, int empno);

	// 부서번호로 검색하기
	public List<Emp> getEmpListByDeptno(int cpage, int pagesize, int deptno);
