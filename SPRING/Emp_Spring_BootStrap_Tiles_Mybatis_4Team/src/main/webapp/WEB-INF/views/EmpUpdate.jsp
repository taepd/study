				 ...
				 <div class="col-md-12">
					<div class="card" style="width: 60%; margin: 0 auto;">
						<form class="form-horizontal"
							action="EmpUpdate.emp?cp=${cp}&ps=${ps}"
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										...
										<input type="file" name="file" style="display: none;" onchange="readURL(this);">
										</label>  <span id="imgFileName">${emp.img}</span> 
										<img id="img" style="width:100px; height:100px"src="upload/${emp.img}" alt="your image" />
									</div>
								</div>
							</div>
						...
						<div class="border-top">
							<div class="card-body">
								<button class="btn btn-primary"
									onclick="location.href='EmpDetail.emp?empno=${emp.empno}&cp=${cp}&ps=${ps}'">뒤로가기</button>
							</div>
						</div>
