                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <div id="profile">
                                        	<c:choose>
                                        		<c:when test="${empty emp.img}"> 
                                        		<img src="upload/profile.png" alt="이미지가 없습니다"style="width:150px; height:150px">
                                        		</c:when>
                                        		<c:otherwise>
                                ...
                                <button class="btn btn-danger" onclick="location.href='EmpUpdate.emp?empno=${emp.empno}&cp=${cp}&ps=${ps}'">정보수정</button>
                                 <button class="btn btn-danger" onclick="location.href='EmpDelete.emp?empno=${emp.empno}&cp=${cp}&ps=${ps}'">사원삭제 </button>
                            	 <button class="btn btn-danger" onclick="location.href='EmpList.emp?cp=${cp}&ps=${ps}'">뒤로가기</button>
                            	 </div>
                            </div>
                        </div>
                    </div>
