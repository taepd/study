	...
	<table
		...
		<tr>
			...
			<td style="width: 700px">
				<form action="boardcontentOK.jsp" method="post" name="joinForm" id="joinForm">
					...
					<div>
						<table
							...
							<tr>
								<th>PWD:</th>
								<td><input type="password" name="name" id="pwd"></td>
							</tr>
							<tr>
								<th>Name:</th>
								<td><input type="text" name="content" id="mname"></td>
							</tr>
							<tr>
								<td colspan="2">
